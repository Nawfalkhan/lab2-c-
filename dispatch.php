...
<table  width="40%" border="1" align="center" cellpadding="4" cellspacing="4">
	...
	<tr>
	   <td align="center" colspan="2" ><strong>Incident Detail</strong></td>
	</tr>
	...
	<tr>
	   ...
	   <td width="50%" ><textarea name="incidentDesc" cols="45" rows="5" readonly id="incidentDesc">
	...
	<?php 
	 ...
	 ?>
	 <tr>
	   <td align="center" ><input type="checkbox" name="chkPatrolCar[]"
	...
	<tr>
	   <td  align="center"><input type="reset" name="btnCancel" id="btnCancel" value="Reset"></td>
		<td  colspan="2" align="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="btnDispatch" id="btnDispatch" value="Dispatch">
	    </td>
	</tr>
	</table>
</form>
